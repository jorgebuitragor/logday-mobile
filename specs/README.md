...
| Pantalla de Dailys | implementado, fila rediseñada + "Eliminar mes" (pendiente confirmación en vivo) | [`pantalla-dailys/`](./pantalla-dailys/requirements.md) |
| Ausencias | implementado (pendiente confirmación en vivo) | [`ausencias/`](./ausencias/requirements.md) |
...
| Sync con logday-server | en progreso — Fase 0 (spike de Yjs) | [`sync-mobile/`](./sync-mobile/requirements.md) |
